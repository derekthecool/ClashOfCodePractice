...
local function testSolutions(input)
    ...
    local solutions = {
        ...
        function(I)
          local numbers = a.range(tonumber(I))
          local even = numbers:filter(function(z)return z%2==0 end):sum()
          local odd = numbers:filter(function(z)return z%2~=0 end):sum()
        ...
        function(I)
          ...
          return string.format(
              "%d\n%d",
              numbers:filter(function(z)return z%2~=0 end):sum(),
              numbers:filter(function(z)return z%2==0 end):sum()
          )
        end
    }
